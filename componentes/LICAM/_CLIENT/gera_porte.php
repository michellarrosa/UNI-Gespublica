...
$codigo_atividade =$_POST['atividade_cod'];
$atividade_tamanho =  $_POST['atividade_tamanho'];
...
//               echo 'quiasa#';
   ...
   $peq_sup =$result[0]['pequeno_superior'];
   $peq_inf =$result[0]['pequeno_inferior'];
   $med_sup =$result[0]['medio_superior'];
   $med_inf =$result[0]['medio_inferior']; 
   $gran_sup =$result[0]['grande_superior'];
   $gran_inf = $result[0]['grande_inferior'];
   $ex_sup =$result[0]['ex_superior'];
   $ex_inf = $result[0]['ex_inferior'];
