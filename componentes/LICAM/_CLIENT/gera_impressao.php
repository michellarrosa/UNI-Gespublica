...
$query = "SELECT * FROM uni__licam_empreendimentodata WHERE id = '". $_REQUEST['dados']."'";
$result = $this->execQuery($query)['result'][0];
$atividade = implode('', $this->execQuery("SELECT descricao FROM com_licam_atividades_tabela WHERE codramo ='".$result['atividade_cod']."'")['result'][0]);
...
$table="<form >
	...
	<h4><center>Imprimir o formulário, anexa-lo juntamente à copia dos documentos e abrir processo junto a secretaria.</center></h4>
	<fieldset>
