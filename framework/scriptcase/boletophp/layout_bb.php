...
<!--<link rel="stylesheet" href="framework/scriptcase/boletophp/style.css">-->
		...
		<tr><td class="last_line" rowspan="6">
			...
			<tr class="campos">
				<td class="instrucoes" rowspan="5">
					<p><?php echo $dadosboleto["demonstrativo1"] . $dadosboleto["demonstrativoprocesso"]; ?></p>		
					<p><?php echo $dadosboleto["demonstrativo2"]; ?></p>
					<p><?php echo $dadosboleto["demonstrativo3"]; ?></p>
					<p><?php echo $dadosboleto["demonstrativo4"]; ?></p>
