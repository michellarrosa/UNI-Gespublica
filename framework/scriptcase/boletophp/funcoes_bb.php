...
// +----------------------------------------------------------------------+
// | Este arquivo estÃ¡ disponÃ­l sob a LicenÃ§a GPL disponÃ­vel pela Web   |
// | em http://pt.wikipedia.org/wiki/GNU_General_Public_License           |
// | Voce deve ter recebido uma cÃ³pia da GNU Public License junto com     |
...
function monta_linha_digitavel($linha) {
    ...
    // 2. Campo - composto pelas posiÃ§Ãµes 6 a 15 do campo livre
